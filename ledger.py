...
def update_command():
    ...
    view_command()
    messagebox.showinfo('Thông báo', 'Đã sửa')
...
b2 = Button(window,text="Update",width=12,command=update_command,bg="blue",fg="red")
...
b5 = Button(window,text="Delete",width=12,command=delete_clicked)
